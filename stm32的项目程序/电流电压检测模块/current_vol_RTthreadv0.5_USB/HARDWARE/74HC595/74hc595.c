...
//			default:		Nnow[i]	=	0xFF;
			...
			case(0x00+'.'): Nnow[i] =(0xC0&0x7f); break;
			case(0x01+'.'): Nnow[i] =(0xF9&0x7f); break;
			case(0x02+'.'): Nnow[i] =(0xA4&0x7f); break;
			case(0x03+'.'): Nnow[i] =(0xB0&0x7f); break;
			case(0x04+'.'): Nnow[i] =(0x99&0x7f); break;
			case(0x05+'.'): Nnow[i] =(0x92&0x7f); break;
			case(0x06+'.'): Nnow[i] =(0x82&0x7f); break;
			case(0x07+'.'): Nnow[i] =(0xF8&0x7f); break;
			case(0x08+'.'): Nnow[i] =(0x80&0x7f); break;
			case(0x09+'.'): Nnow[i] =(0x90&0x7f); break;
			case	'a':	Nnow[i]	=	0x88;	break;
			case	'u':	Nnow[i]	=	0xc1;	break;
			case	'c':	Nnow[i]	=	0xC6;	break;
			case	'd':	Nnow[i]	=	0xA1;	break;
			...
			case	'h':	Nnow[i]	=	0x8B;	break;
			case	'o':	Nnow[i]	=	0xA3;	break;
			case	'n':	Nnow[i]	=	0xAB;	break;
//			case	'o':	Nnow[i]	=	0x86;	break;
			case	'r':	Nnow[i]	=	0xAF;	break;
