...
#define RCC_ADCCLK_PCLK_Div6             ((uint32_t)0x01008000)
#define RCC_ADCCLK_PCLK_Div8             ((uint32_t)0x0100C000)

#define IS_RCC_ADCCLK(ADCCLK) (((ADCCLK) == RCC_ADCCLK_HSI14) || ((ADCCLK) == RCC_ADCCLK_PCLK_Div2) || \
                               ((ADCCLK) == RCC_ADCCLK_PCLK_Div4)|| ((ADCCLK) == RCC_ADCCLK_PCLK_Div6)|| \
																|| ((ADCCLK) == RCC_ADCCLK_PCLK_Div8))
/**
  * @}
  */
