...
#define KEY0        PAin(10) //一号按键
#define KEY1        PAin(9)  //二号按键
#define KEY2        PAin(8)  //三号按键
#define KEY3        PBin(15) //四号按键
#define KEY4        PAin(11)  //五号按键
#define KEY5        PBin(14) //六号按键
#define KEY6        PBin(13) //七号按键
#define KEY7        PBin(12) //八号按键
...
//二组按键
#define KEY4_PRES 	0x01
#define KEY5_PRES	0x02
#define KEY6_PRES	0x04
#define KEY7_PRES   0x08


#define NONE_PRES   0x00
#define NONE_STATE  0x0a
//void KEY_Init(void);


void Get_Keyval(void);
void Key_filter(void);
u8 KEY_Scan_GroupOne(u8 mode);
u8 KEY_Scan_GroupTwo(u8 mode);
