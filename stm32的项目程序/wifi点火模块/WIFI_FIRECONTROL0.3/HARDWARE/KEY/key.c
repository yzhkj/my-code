...
//void Get_Keyval_GroupTwo(void)
//{
//    if(KEY4==ON_LEVEL)
//        Cur2_Keyval|= KEY4_PRES;
//    else
//        Cur2_Keyval&=~KEY4_PRES;

//    if(KEY5==ON_LEVEL)
//        Cur2_Keyval|= KEY5_PRES;
//    else
//        Cur2_Keyval&=~KEY5_PRES;
//	
//    if(KEY6==ON_LEVEL)
//        Cur2_Keyval|= KEY6_PRES;
//    else
//        Cur2_Keyval&=~KEY6_PRES;

//    if(KEY7==ON_LEVEL)
//        Cur2_Keyval|= KEY7_PRES;
//    else
//        Cur2_Keyval&=~KEY7_PRES;
//}
...
u8 KEY_Scan_GroupTwo(u8 mode)
{
    static u8 key_up=1;     //按键松开标志
    if(mode==1)key_up=1;    //支持连按
    if(key_up&&(KEY4==1||KEY5==1||KEY6==1||KEY7==1))
    {
//        delay_ms(10);
		HAL_Delay(10);
        key_up=0;
        if(KEY4==1)       return KEY4_PRES;
        else if(KEY5==1)  return KEY5_PRES;
        else if(KEY6==1)  return KEY6_PRES;
        else if(KEY7==1) return  KEY7_PRES;          
    }else if(KEY4==0&&KEY5==0&&KEY6==0&&KEY7==0)key_up=1;
    return 0;   //无按键按下
}
