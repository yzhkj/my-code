...
uint table[21]={1000,1010,1015,1020,1022,1023,1024,1025,1026,1027,1028,1029,1030,1032,1035,1040,1050,1060,1075,1095,1120};
...
void main(void)
{
 ...
 {
   dis_init2(); 
//   if(distance>10) qi_flag=1; 
//   else{ TBCCR1=900; qi_flag=0;}
//    if(qi_flag==0)
//    {        
//        if(distance<15)
//        {
...
//    mode=4;
    switch(mode)
    {
      case 0:
        max=1040;
        min=1020;
        PID_Control(20,(int)(buchang-distance));
        break;
        
      case 1:
//        max=1100;
        PID_Control(10,(int)(buchang-distance));
        start_flag=0;
        break;
