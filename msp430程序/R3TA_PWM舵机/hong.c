...
//*************************************************************************
 void Key_Icode(void)
 {
   ...
   case KEY_0:KEY_VAL=0;TBCCR4-=100;if(TBCCR4<=500) TBCCR4=500;break;
   case KEY_1:KEY_VAL=1;TBCCR5-=100;if(TBCCR5<=500) TBCCR5=500; break;
   case KEY_2:KEY_VAL=2;TBCCR5+=100;if(TBCCR5>=2500) TBCCR5=2500; break;
   case KEY_3:KEY_VAL=3;P2OUT=BIT3; break;
   case KEY_4:KEY_VAL=4; TACCR2-=100;if(TACCR2<=500) TACCR2=500; break;
   case KEY_5:KEY_VAL=5; TACCR2+=100;if(TACCR2>=2500) TACCR2=2500; break;
   case KEY_6:KEY_VAL=6; P2OUT=BIT6; break;
   case KEY_7:KEY_VAL=7;TACCR1-=100;if(TACCR1<=500) TACCR1=500; break;
   case KEY_8:KEY_VAL=8;TACCR1+=100;if(TACCR1>=2500) TACCR1=2500; break;
   case KEY_9:KEY_VAL=9;P2OUT=BIT0; break;
   case KEY11:KEY_VAL=11;TBCCR1-=100;if(TBCCR1<=500) TBCCR1=500;break;
   case KEY12:KEY_VAL=12;TBCCR1+=100;if(TBCCR1>=2500) TBCCR1=2500;break;
   case KEY13:break;
   case KEY14:KEY_VAL=14;TBCCR2-=100;if(TBCCR2<=500) TBCCR2=500;break;
   case KEY15:KEY_VAL=15;TBCCR2+=100;if(TBCCR2>=2500) TBCCR2=2500;break;
   case KEY16:break;
   case KEY17:KEY_VAL=17;TBCCR3-=100;if(TBCCR3<=500) TBCCR3=500; break;
   case KEY18:KEY_VAL=18;TBCCR3+=100;if(TBCCR3>=2500) TBCCR3=2500;break;
   case KEY19:KEY_VAL=19;TBCCR4+=100;if(TBCCR4>=2500) TBCCR4=2500;break;
