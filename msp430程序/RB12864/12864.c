...
#define LCD_CMDOut    P4DIR|=0x1f     //P3口的低三位设置为输出
#define LCD_RS_H      P4OUT|=BIT5      //P6.2
#define LCD_RS_L      P4OUT&=~BIT5     //P6.2
#define LCD_RW_H      P4OUT|=BIT6      //P6.3
#define LCD_RW_L      P4OUT&=~BIT6     //P6.3


#define LCD_EN_H      P2OUT|=BIT5      //P6.4
#define LCD_EN_L      P2OUT&=~BIT5     //P6.4
#define LCD_PSB_H      P4OUT|=BIT6      //P6.5
#define LCD_PSB_L      P4OUT&=~BIT6     //P6.5
#define LCD_RST_H      P6OUT|=BIT6      //P6.6
#define LCD_RST_L      P6OUT&=~BIT6     //P6.6
/*******************************************/
void Delay_1ms(void);
void Delay(unsigned int n);0
